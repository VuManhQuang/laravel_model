 ...
 <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a onclick="location.href='{{ route('backend.nhomquantri.getSua',$data['id'])}}'" href="javascript:void(0)">Sửa nhóm quản trị</a>
                    </li>
                </ol>
            </section>
@endsection            
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                        <form  action="{{ route('backend.nhomquantri.getSua',$data['id'])}}" method="POST" class="form-horizontal" enctype="multipart/form-data" >
                          {{ csrf_field() }}
                                             <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="name" type="text" name="name" class="form-control" placeholder="Mời bạn nhập tên nhóm quản trị"  value="{!! old('ten',isset($data) ? $data['description'] : null) !!}" >
                                                        </div>
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        @foreach($permissions as $permission)
                                                            <div class="checkbox text-left">
                                                                <label>
                                                                 <input  type="checkbox" name="permission[]"   value="{{ $permission->id }}" {{in_array($permission->id,$role_permissions)?"checked":""}}> {{$permission->display_name}}                                                                
                                                                 </label>
                                                            </div>

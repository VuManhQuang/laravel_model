                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="box-model">
                            ...
                            <div class="newstick">
                                <div class="recent">
                                    <div class="row">
                                        <img src="{{ url('public/backend/img/admin/user1.png}')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                               ...
                               25 / 08 / 2016</span></small>
                                    ...
                                    <div class="row bg-default">
                                        <img src="{{ url('public/backend/img/admin/user2.png')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                                ...
                                23 / 08 / 2016</span></small>
                                 ...
                                 19 / 08 / 2016</span></small>
                                    ...
                                    <div class="row bg-default">
                                        <img src="{{ url('public/backend/img/admin/user4.png')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                                ...
                                15 / 08 / 2016</span></small>
                                    ...
                                    <div class="row">
                                        <img src="{{ url('public/backend/img/admin/user5.png')}}" class="recent-user-img" alt="image not found">
                                        <h5>
                                ...
                                <div class="box-model event">
                                    ...
                                    <div class="events_hover">
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="{{ url('public/backend/img/admin/event1.png')}}" class="recent-user-img" alt="image not found">
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="{{ url('public/backend/img/admin/event3.png')}}" class="recent-user-img" alt="image not found">
                                                <h5> 5k Marthon </h5>
                                        ...
                                        <a href="event_item.html">
                                            <div class="row">
                                                <img src="{{ url('public/backend/img/admin/event5.png')}}" class="recent-user-img" alt="image not found">

 <nav class="navbar navbar-static-top">
            <a href="index.html" class="logo">
                ...
                <img src="{{ url('public/backend/logo.png')}}" alt="180x45" style="width:180px;height: 45px;" class="img-responsive">
            </a>
                ...
                <ul class="nav navbar-nav">
                        ...
                        <ul class="dropdown-menu dropdown-messages table-striped">
                            ...
                            <li>
                                <a href="#" class="message striped-col">
                                    <img class="message-image img-circle" alt="image" src="{{ url('public/backend/img/authors/avatar7.jpg')}}">
                            ...
                            <li>
                                <a href="#" class="message">
                                    <img class="message-image img-circle" alt="image" src="{{ url('public/backend/img/authors/avatar.jpg')}}">
                            ...
                            <li>
                                <a href="#" class="message striped-col">
                                    <img class="message-image img-circle" alt="image" src="{{ url('public/backend/img/authors/avatar5.jpg')}}">
                            ...
                            <li>
                                <a href="#" class="message">
                                    <img class="message-image img-circle" alt="image" src="{{ url('public/backend/img/authors/avatar1.jpg')}}">
                                    <div class="message-body">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle padding-user" data-toggle="dropdown">
                            <img src="{{ url('public/backend/img/admin/16002952_750640788424041_5708182976617268282_n.jpg')}}" width="35" class="img-circle img-responsive pull-left" height="35" alt="User Image">
                            <div class="riot">
                                <div>
                                    <?php $lastname='';
                                          $chuoiten=  explode(' ',Auth::user()->name);
                                          if(count($chuoiten)>0){
                                          $lastname=$chuoiten[count($chuoiten)-1];
                                          }
                                       ?>
                                    {!!  $lastname !!}
                                    <span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="pad-3">
                                <a href="#">
                                    <i class="fa fa-fw fa-user"></i> Thông tin cá nhân
                                </a>
                            </li>
                            <li role="presentation"></li>
                            <li>
                                <a href="#">
                                    <i class="fa fa-fw fa-gear"></i> Cài đặt
                                </a>
                            </li>
